...
function GSEStorage() {
    ...
    function setup() {
        //Must exist
        if (window.localStorage == null) return alert('Error 3: Gab Share Extension requires that your browser\'s "Local Storage" be enabled.');
